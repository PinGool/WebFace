...
.reg{width:460px; font-size:14px;line-height:25px; overflow:hidden;top: 50%;left: 50%;position: absolute;}
...
<!--登录开始-->
    <div class="reg login">
        ...
        <form action="login_login.action" method="post" name="form1" id="form1">
            <dl>
                <div style="height:17px; overflow:hidden"></div>
                <dd><span class="title">登录账号：</span><input class="reg_input" name="user.name" id="t_UserName" onblur="checkusername(this.value);" type="text" /><span id="t_UserNameTip" class="onshow"></span></dd>
            ...
            <div class="f_reg_but"><input id="button" name="button" type="submit" value="登录" class="l_button"/><span class="clew_txt">还没账号？<a href="<%=basePath%>FaceTop_add.action">立即注册</a></span></div>
        </form>                      
    </div>
<!--登录结束-->   
</body>

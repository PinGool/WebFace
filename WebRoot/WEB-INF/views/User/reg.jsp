...
body{behavior:url("${pageContext.request.contextPath}/css/hover_htc.htc");font-family:"Microsoft YaHei",宋体; color:#333;}/*hover*/
...
.l_button,.r_button{background:url(${pageContext.request.contextPath}/Images/login_button.png) no-repeat; width:118px; height:39px; border:none; cursor:pointer; display:block; float:left; text-indent:-9000px}
...
.reg{width:460px; font-size:14px;line-height:25px; overflow:hidden;position: absolute;top: 20%;left: 34%}
...
.onShow,.onFocus,.onError,.onCorrect,.onLoad{background:url(${pageContext.request.contextPath}/Images/reg_bg.png) no-repeat 3000px 3000px;padding-left:30px; font-size: 12px; height:25px; width:124px; display:inline-block; line-height:25px; vertical-align:middle; overflow:hidden; margin-left:6px}
...
<script src="${pageContext.request.contextPath}/Js/jquery-1.2.6.min.js" type=text/javascript></script>
<script src="${pageContext.request.contextPath}/Js/formValidator_min.js" type="text/javascript" charset="UTF-8"></script>
<script src="${pageContext.request.contextPath}/Js/formValidatorRegex.js" type="text/javascript" charset="UTF-8"></script>
...
<!--注册开始-->
    <div class="reg">
        <form action="${pageContext.request.contextPath}/FaceUser_save.action" method="post" enctype="multipart/form-data" >
            <dl>
                <dt class="f14 b">帐户基本信息</dt>
                <dd><span class="title">登录账号：</span><s:textfield class="reg_input" name="user.name" id="t_UserName" onblur="checkusername(this.value);"  /><span id="t_UserNameTip" class="onshow"></span></dd>
                                                            

                <dd><span class="title">性别：</span>
                    <s:radio name="user.sex" list="#{'男':true,'女':false}" listKey="value" listValue="key" value="true"></s:radio>                
                </dd>
            </dl>
            <dl>           
                ...
                <dd><span class="title">真实姓名：</span><input name="user.trueName" id="iptName" class="reg_input" type="text" onblur="return isCnn(this)" /><span id="iptNameTip" class="onshow"></span></dd>
                <dd><span class="title">身份证号：</span><input class="reg_input" name="user.iptCard" type='text' id='iptCard' onblur="return checktheform();" /><span id="iptCardTip" class="onshow"></span></dd>
                ...
                <dd><span class="title">图片上传：</span><input type="file" name="file"/></dd>


                <dd><span class="title">验证码：</span><input id="t_CheckCode" class="reg_input_pic" name="t_CheckCode" type="text" maxlength="4" />
                <img class="img" src="${pageContext.request.contextPath}/Images/eee.jpg" width="60" height="30" /><span id="t_CheckCodeTip" class="reg_m onError in_pic_s">sdsdas</span></dd>


            </dl>
            <div class="f_reg_but"><input  type="submit" value="免费注册" class="r_button"/><span class="clew_txt">如果您已有帐号，可<a href="#">直接登录</a></span></div>
        </form>                              
    </div>
<!--注册结束-->        
</body>
